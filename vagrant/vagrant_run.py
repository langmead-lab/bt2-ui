...
Options:
  ...
  --aws-profile <path>       Which profile from --aws-json to use [default: jhu_ue2].
  --skip-slack               Don't send message to Slack.
  --no-destroy-on-error      Keep instance running on error.
  --slack-ini <ini>          ini file for Slack webhooks [default: ~/.bt2-ui/slack.ini].
...
""" ~/.bt2-ui/slack.ini file should look like this:
[slack]
tstring=TXXXXXXXX
bstring=BXXXXXXXX
